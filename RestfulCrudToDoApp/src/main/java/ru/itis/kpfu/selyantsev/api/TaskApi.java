...
public interface TaskApi {
    ...
    Mono<UUID> create(@PathVariable UUID userId, @RequestBody TaskRequest task);
    ...
    @ResponseStatus(HttpStatus.OK)
    Flux<TaskResponse> findAllTasksByUserId(@RequestParam UUID userId);
    ...
    @Operation(summary = "Delete all tasks by userId")
    @ApiResponses(value = {
    ...
    Mono<Void> deleteUsersTaskById(@RequestParam UUID userId);
}
